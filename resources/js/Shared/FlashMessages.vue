<template>
  <div>
    <div v-if="$page.flash.success && show" class="mb-4 flex items-center justify-between bg-indigo-600 rounded max-w-7xl">
    ...
    <div v-if="($page.flash.error || Object.keys($page.errors).length > 0) && show" class="mb-4 flex items-center justify-between bg-red-600 rounded max-w-7xl">
      <div class="flex items-center">
